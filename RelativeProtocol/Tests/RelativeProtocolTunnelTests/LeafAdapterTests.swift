...
final class LeafAdapterTests: XCTestCase {
    ...
    func testStartAndStopLifecycle() throws {
        ...
        let engine = MockLeafRuntimeEngine()
...
private final class MockLeafRuntimeEngine: LeafRuntimeEngine {
